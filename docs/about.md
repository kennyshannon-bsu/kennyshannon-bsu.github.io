<div class="about-header">
  <img src="assets/profile.jpg" alt="Portrait of Kenny Shannon" class="about-avatar" width="166" height="250" loading="lazy" />
  <div class="about-header-content">
    <h1 class="title">Hi I'm Kenny!</h1>
    <div class="about-socials" style="display:flex;gap:1.25rem;align-items:center;flex-wrap:wrap;margin-top:0.5rem;">
  <a href="https://github.com/kennyshannon-bsu" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="mailto:kennyshannon@u.boisestate.edu" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
